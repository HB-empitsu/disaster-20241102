...
# グラフの表示
tab1.plotly_chart(fig_dam, use_container_width=True)

df_dam.set_index("日時", inplace=True)

tab1.dataframe(df_dam.style.highlight_max(axis=0), use_container_width=True)
...
# グラフの表示
tab2.plotly_chart(fig_river, use_container_width=True)

df_river.set_index("日時", inplace=True)

tab2.dataframe(df_river.style.highlight_max(axis=0), use_container_width=True)
